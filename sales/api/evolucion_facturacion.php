...
try {
    ...
    $rubros = $db->getEvolucionRubrosFacturacion($da, $ha, $dp, $hp, $canal);

    // EvoluciÃ³n mensual multi-aÃ±o para el grÃ¡fico
    $evolucion = $db->getEvolucionMensualFacturacion($canal, $rubro, 4);

    // Tabla mensual por canal
    $tablaMensual = $db->getTablaFacturacionCanalMes($anio, $canal, $rubro);
